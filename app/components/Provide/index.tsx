...
const Aboutdata: datatype[] = [
    {
        ...
        country: "Vulnerability Testing",
        paragraph: 'Identify and fix system weaknesses.',

    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Threat Defense",
        paragraph: 'Stay ahead of evolving cyber risks.',

    },
    {
        imgSrc: "/assets/provide/heaking.svg",
        country: "Risk Assessment",
        paragraph: 'Ongoing checks for secure data.',

    },
    {
        imgSrc: "/assets/provide/uidesign.svg",
        country: "Defense Planning",
        paragraph: 'Customized strategies for robust security.',
    },
]
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            <p className="text-4xl lg:text-6xl pt-4 font-semibold lh-81 mt-5 text-center lg:text-start">Securing Your Digital World.</p>
                            <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">SafeMax Security delivers expert, precision-driven cybersecurity solutions to safeguard your critical digital assets and secure your business against evolving threats.</h4>
