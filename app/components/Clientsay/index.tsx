                ...
                <div className="lg:relative">
                    ...
                    <span className="lg:absolute lg:bottom-40 lg:left-80">
                        ...
                        <div className="lg:inline-block bg-white rounded-2xl p-5 shadow-sm">
                            <p className="text-base font-normal text-center text-darkgray">Description about comments Description about comments<br/>Description about comments Description about comments<br/> </p>
                            <h3 className="text-2xl font-medium text-center py-2">Client name</h3>
                            <h4 className="text-sm font-normal text-center">Profession / company</h4>
                        </div>
                    </span>
